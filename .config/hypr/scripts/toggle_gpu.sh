...
CURRENT_LINK="$CONF_DIR/custom/env_current.lua"
BATTERY_CONF="$CONF_DIR/custom/env_battery.lua"
DESK_CONF="$CONF_DIR/custom/env_desk.lua"

# Deteksi string "mesa" pada baris GLX_VENDOR_LIBRARY_NAME
if grep -q "mesa" "$CURRENT_LINK"; then
